...
const newData = [
  ...
  },
  {
    ...
    title: "Manage Intrested Parties"
  },
  {
      ...
      <>
        {this.props.register ? (
          <TouchableOpacity style={styles.loginHeader}>
            ...
            >
              <GIcon name="typing" type="entypo" size={50} color="grey" />
            </TouchableOpacity>
          </TouchableOpacity>
        ) : (
          <>
            <TouchableOpacity style={styles.loginHeader}>
              <TouchableOpacity
                style={{ width: "25%", height: scaledWidth(50) }}
                onPress={this.headerClicked}
              >
                <Image
                  style={{
              ...
              {!this.props.registerShow ? (
                ...
                >
                  <GIcon name="user" type="evilicon" size={40} color="black" />
                </TouchableOpacity>
              ) : null}
            ...
            {this.state.menuList && (
              ...
              >
                ...
                />
                {this.state.SignOut ? (
                  <Modal transparent visible={this.state.ModalVisibleStatus}>
