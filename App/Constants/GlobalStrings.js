...
export default {
    ...
    accManagement: {
        ...
        addPrimaryBeneficiary: "Add Another Primary Beneficiary",
        ...
        verifyIntrestedPartyInfo: "Verify - Interested Party Information",
        effStartDate: "Effective Start Date",
        effEndDate: "Effective End Date",
        mailingAdd: "Mailing Address",
        editIntrestedParty: "Edit-Interested Party of",
    ...
    userManagement: {
        ...
        marketingPrivacy: "Marketing and Offers",
    ...
    dividents: {
        ...
        future_fund_header: 'To set all future funds purchased in this account to reinvest dividend select "Yes, I want to Reinvest.\n\nTo deposit dividend proceeds into your cash account select "No, I do not Reinvest"',
        current_fund_header: 'To set current funds purchased in this account to reinvest dividend select "Yes, I want to Reinvest".\n\nTo deposit dividend proceeds into your cash account select "No, I do not Reinvest".',
        ...
        dividents_faq: "FAQs",
        do_not_reinvest: "No, I do not Reinvest",
        account_number: "Account Number",
        current_value: 'Current Value',
        holding: 'Holding',
        current_funds: 'Current Funds',
        future_funds: 'Future Funds',
    ...
    liquidation: {
        ...
        fundWithdrawalHeading: "3 - Funding Option",
        ...
        accountSelectionScreenName: "1 - Account Selection",
        fundSelectionScreenName: "2 - Fund Selections",
        liquidationYourFund: "Liquidation your Fund",
    ...
    marketingPrivacyLabel: {
        ...
        marketingContactEnableLabel: "Enable",
        marketingContactDisableLabel: "Disable",
        ...
        marketingHeadingLabel: "Settings > Marketing and Offers",
        marketingPrivacyTitle: "Marketing and Offers",
    ...
    purchase: {
        ...
        investmentSelection: "Investment Selection",
        selectVcmMutualFund: " - Select Your VCM Mutual Funds",
        fillerFund: "Filter Funds",
        compareFund: "Compare Funds (up to 4)",
        selectStmt: "Select a ONE funds from the list below.",
        useFilterStmt: "Use the filter to narrow the list",
        loadMore: "Load More > ",
        fundSource: "Fund Source",
        fundYourAcc: " - Fund Your Investments",
        fundAcc: " - Fund Your Account",
        fundStmt: "Choose how you will fund your account and indicate your initial investment amount.",
        fundAccStmt: "Choose your funding options below. For monthly investments, the start day of the month must be a business day and at least 1 business day from today. If the day of the month you select is a holiday, the transaction will occur on the next business day. If you are selecting a monthly investment, please read this important notice",
        offlineMethod: "Offline Method",
        commnStmt: "Lorem ipsum dolor sit amet, consectetur adipiscing elitdh Nam imperdiet dictum orcittet",
        checkOrder: "Check Order",
        wireTransfer: "Wire Transfer",
        or: "or",
        onlineMethod: "Online Method",
        addBnkAcc: "Add Bank Account",
        dividendsCapitalGain: " - Dividends and Capital Gains Preferences",
        reinvestStmt: "Do you want to Reinvest Dividends and Capital Gains?",
        cashOrderWireTransferStmt: "You will not have option to receive cash while choose Check Order & Wire Transfer.",
        notReinvest: "I do not Reinvest",
        reinvest: "I want to Reinvest",
        yes: "Yes",
        no: "No",
        contribution: "- Contribution",
        contDummyText: "Lorem Ipsum is simply dummy text of the printing and typesetting industry.",
        contForIRAAccount: "Contribution for IRA Account",
        check: "- Check",
        checkOrderStmt1: "The Dividend Reinvestment option is set to Reinvest. You will not have option to receive cash while choose Check Order.",
