...
const styles = StyleSheet.create({
    ...
    financialInfoLabel: {
        color: '#707070', fontSize: scaledHeight(18), fontWeight: 'bold', marginRight: '4%', width: '100%'
    },
    financialSecurityLabel: {
        color: '#56565A', fontSize: scaledHeight(18)
    },
    financialTextLabel: {
        color: '#333333DE', fontSize: scaledHeight(18), fontWeight: 'bold', marginBottom: '4%', marginTop: '4%'
    },
    financialValueLabel: {
        color: '#56565A', fontSize: scaledHeight(16), marginLeft: '4%'
    },
    financialView: {
        flexDirection: 'column', marginLeft: '4%', marginRight: '4%', marginTop: '4%', width: '92%'
    },
    financialViewNormal: {
        flexDirection: 'column', marginLeft: '4%', marginRight: '4%', width: '92%'
    },
    forgotLineText: {
        flexDirection: 'row',
        fontSize: scaledHeight(18),
