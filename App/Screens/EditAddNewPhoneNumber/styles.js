...
const styles = StyleSheet.create({
    ...
    editAddressInput: { flexDirection: 'column', paddingLeft: '2%', paddingRight: '4%', width: '100%' },
    ...
    phonePreferredLabel: {
        alignItems: 'center', color: '#56565A', fontSize: scaledHeight(16), fontWeight: 'bold', width: '80%'
    },
    phoneSecurityLabel: {
        color: '#56565A', fontSize: scaledHeight(18)
    },
    phoneTypeLabel: {
        color: '#333333DE', fontSize: scaledHeight(18), fontWeight: 'bold', height: scaledHeight(22)
    },
    privacyAgreement: {
        alignItems: 'center',
        backgroundColor: 'white',
