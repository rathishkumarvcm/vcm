...
const styles = StyleSheet.create({
    ...
    editAddressBackground: {
        backgroundColor: '#FFFFFF', padding: scaledHeight(15), width: '100%'
    },
    editAddressBorder: {
        borderBottomWidth: 1, borderColor: '#B2B2B2', marginTop: '5%', width: '100%'
    },
    editAddressCityLabel: {
        color: '#333333DE', fontSize: scaledHeight(18), fontWeight: 'bold', margin: '2%'
    },
    editAddressCityValue: {
        color: '#56565A', fontSize: scaledHeight(18), margin: '2%'
    },
    editAddressInput: { flexDirection: 'column', justifyContent: 'center', marginBottom: '2%', paddingLeft: '2%', paddingRight: '2%', width: '100%' },
