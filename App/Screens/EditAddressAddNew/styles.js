...
const styles = StyleSheet.create({
    ...
    editAddressCityLabel: {
        color: '#333333DE', fontWeight: 'bold', margin: '2%', fontSize: scaledHeight(18)
    },
    editAddressCityValue: {
        color: '#56565A', margin: '2%', fontSize: scaledHeight(18)
    },
    editAddressBorder: {
        marginTop: '5%', width: '100%', borderBottomWidth: 1, borderColor: '#B2B2B2'
    },
