...
export const styles = StyleSheet.create({
    ...
    editEmailPrimaryPreferred: {
        flexDirection: 'row', marginLeft: '4%', width: '92%', alignItems: 'center', justifyContent: 'center'
    },
    editEmailDeleteLabel: {
        color: '#5D83AE', width: '32%', fontSize: scaledHeight(18), fontWeight: 'bold'
    },
    editEmailPreferred: {
        width: '60%'
    },
    ...
    editEmailInformations: {
        flexDirection: 'row', alignSelf: 'baseline'
    },
    editEmailLabelInfo: {
        lineHeight: 30, color: '#56565A', fontSize: scaledHeight(18), width: '92%', marginRight: '4%', marginTop: '4%', marginLeft: '4%', marginBottom: '2%'
    },
    editEmailSecurity: {
