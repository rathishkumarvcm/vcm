...
const styles = StyleSheet.create({
    ...
    editFamilyDetailHeader: { flexDirection: 'column', marginRight: '4%', width: '96%' },
    ...
    editFamilyDetailValueLabel: { color: '#333333DE', fontSize: scaledHeight(16), fontWeight: 'bold', marginBottom: '4%', marginTop: '3%' },
    editFamilyDetailView: { color: '#0000FF', fontSize: scaledHeight(14) },
    editFamilyHeadView: { color: '#56565A', fontSize: scaledHeight(18), fontWeight: 'bold', width: '100%' },
    editFamilyInstBackground: { backgroundColor: '#F1F1F2', flexDirection: 'column', marginLeft: '4%', marginRight: '4%', marginTop: '4%', width: '92%' },
    editFamilyInstContent: { color: '#56565A', fontSize: scaledHeight(18), lineHeight: 30, margin: '3%', textAlign: 'justify' },
    ...
    familyDetailFlex: {flex : 0.85},
    familyDetailHeader: { color: '#56565A', fontSize: scaledHeight(14) },
    forgotLineText: {
        flexDirection: 'row',
        fontSize: scaledHeight(18),
        paddingLeft: '4%',
    ...
    profileSettingsNameView: { color: '#0000FF', fontSize: scaledHeight(16), marginBottom: '2%', marginTop: scaledHeight(3) },
    registernowButton: {
        alignItems: 'center',
        backgroundColor: '#FFFFFF',
        borderColor: '#56565A',
