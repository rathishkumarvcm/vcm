...
const styles = StyleSheet.create({
    ...
    editFamilyBackground: { backgroundColor: '#FFFFFF', borderColor: '#D4D4D4', borderWidth: 1, marginLeft: '4%', marginRight: '4%', marginTop: scaledHeight(20), width: '92%' },
    editFamilyDivideThree: { color: '#0000FF', fontSize: scaledHeight(14), textAlign: 'right', width: '30%' },
    editFamilyDivideTwo: { color: '#56565A', fontSize: scaledHeight(18), fontWeight: 'bold', width: '70%' },
    editFamilyLabel: { color: '#333333DE', fontSize: scaledHeight(16), fontWeight: 'bold' },
    editFamilyMemberDivideOne: { alignItems: 'center', justifyContent: 'center' },
    ...
    editFamilyNameLabel: { color: '#0000FF', fontSize: scaledHeight(16), marginBottom: '2%', marginTop: scaledHeight(3) },
    editFamilyValue: { color: '#56565A', fontSize: scaledHeight(16), marginBottom: '2%', marginTop: scaledHeight(3) },
    ...
    familyMemberFlex: { flex: 0.85 },
    familyMemberRegulatory: {
        alignItems: 'center',
        flexDirection: 'row',
        justifyContent: 'center',
