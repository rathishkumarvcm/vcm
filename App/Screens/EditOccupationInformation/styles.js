...
const styles = StyleSheet.create({
    ...
    editAddressInput: { flexDirection: 'column', marginBottom: '2%', paddingLeft: '1%', paddingRight: '4%', width: '100%' },
    ...
    occupationEmployeeDetail: { alignItems: 'center', flexDirection: 'row', justifyContent: 'center', width: '100%' },
    occupationEmployeeOne: { color: '#56565A', fontSize: scaledHeight(18), fontWeight: 'bold', width: '70%' },
    occupationEmployeeTwo: { color: '#333333DE', fontSize: scaledHeight(14), textAlign: 'right', width: '30%' },
    occupationEmployeeView: { flexDirection: 'column', marginTop: scaledHeight(20), paddingLeft: '4%', paddingRight: '4%', width: '100%' },
    ...
    occupationEmploymentView: { flexDirection: 'column', marginLeft: '4%', marginRight: '4%', marginTop: '4%', width: '92%' },
    occupationFlex: { flex: 0.85 },
