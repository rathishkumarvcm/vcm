...
class ExchangeScreenOneComponent extends Component {
    ...
    nextButtonAction = () => {
        ...
        navigation.navigate({ routeName: 'exchangeScreenTwo', key: 'exchangeScreenTwo' });
    }
    ...
    render() {
        ...
        if (this.props && exchangeData && exchangeData.accSelectionData) {
            accSelectionData = exchangeData.accSelectionData;
            savedData = exchangeData.savePurchaseSelectedData;
        }
