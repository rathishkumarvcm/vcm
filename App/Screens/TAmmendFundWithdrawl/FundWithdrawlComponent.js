...
import { styles } from '../LiquidationPageThree/styles';
...
class FundWithdrawlComponent extends Component {
    constructor(props) {
        super(props);
        this.state = {
            switchOff: true,
    ...
    navigateAmmendPageOne = () => this.props.navigation.navigate('FundSelectionComponent');
    navigateAmmendThree = () => this.props.navigation.navigate('ReviewConfirmComponent', { taxAccountingMethodData: this.state.taxAccountingMethodData, fundingSource: this.state.fundingSource });
            ...
            <View style={styles.container} >
                ...
                <ScrollView style={styles.mainFlex}>
                    ...
                    <View style={styles.flex6}>
                        ...
                        <TouchableOpacity style={styles.backButtonFlex} onPress={this.navigateAmmendPageOne}>
                            <Text style={styles.backButtonText}>{gblStrings.common.back}</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.submitFlex} onPress={this.navigateAmmendThree}>
...
FundWithdrawlComponent.propTypes = {
    navigation: PropTypes.instanceOf(Object)
};

FundWithdrawlComponent.defaultProps = {
