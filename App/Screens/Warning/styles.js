...
const styles = StyleSheet.create({
  attemptsLeft:{alignSelf:'center',color:'#49494A',fontSize:scaledHeight(18),fontWeight:'bold',justifyContent:'center',marginLeft:'2%',marginRight:'2%',marginTop:scaledHeight(50)},
  bottomView: {
    alignItems: 'center',
  ...
  continueButton:{alignSelf:'center',backgroundColor:"#194C7D",height:scaledHeight(44),justifyContent:'center',marginTop:scaledHeight(40),width:'60%'},
  continueText:{color:'#FFFFFF',fontSize:scaledHeight(18)},
  cornerTriangle: {
