...
describe('Relationship Detail Information', () => {
    ...
    it('snap shot', () => {
        const tree = renderer.create(<EditRelationDetailInformations getProfileCompositeData={getProfileCompositeData} navigation={navigation} />).toJSON();
    ...
    // Application Render
    test('render', () => {
        const component = shallow(<EditRelationDetailInformations getProfileCompositeData={getProfileCompositeData} navigation={navigation} />);
