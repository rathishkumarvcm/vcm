...
describe('Edit Relationship Informations', () => {
    ...
    it('snap shot', () => {
        const tree = renderer.create(<EditRelationshipInformations getProfileCompositeData={getProfileCompositeData} navigation={navigation} />).toJSON();
    ...
    // Application Render 
    test('render', () => {
        const component = shallow(<EditRelationshipInformations getProfileCompositeData={getProfileCompositeData} navigation={navigation} />);
